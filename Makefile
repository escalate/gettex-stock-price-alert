...
test-docker-image: clean-python-venv clean-python-cache
	docker compose --file docker-compose.test.yml build gettex-stock-price-alert-test

.PHONY: run-docker-image
run-docker-image: clean-python-venv clean-python-cache
	docker compose --file docker-compose.yml run --rm gettex-stock-price-alert --help
